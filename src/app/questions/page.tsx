  ...
  const fetchQuestions = async () => {
    ...
    try {
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/getTQ`,
        {
          jd,
          limit,
        }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2">
              practice the Question Generator
            </h1>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Provide detailed job requirements, responsibilities, and
                      qualifications
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        value={limit}
                        onChange={(e) =>
                          setLimit(Math.max(1, parseInt(e.target.value) || 5))
                        }
              ...
              <Card>
                <CardContent className="py-12">
                  <p className="text-center text-muted-foreground">
                    No questions yet — paste a job description and click
